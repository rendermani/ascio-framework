...
class TradeMark extends DbBase  {
	...
	*/
	...
	public function setName (?string $Name = null) : \ascio\v2\TradeMark {
		$this->set("Name", $Name);
		return $this;
	}
	...
	public function setCountry (?string $Country = null) : \ascio\v2\TradeMark {
	...
	public function setDate (?\DateTime $Date = null) : \ascio\v2\TradeMark {
		$this->set("Date", $Date);
		return $this;
	}
	...
	public function setNumber (?string $Number = null) : \ascio\v2\TradeMark {
	...
	public function setType (?string $Type = null) : \ascio\v2\TradeMark {
		$this->set("Type", $Type);
		return $this;
	}
	...
	public function setContact (?string $Contact = null) : \ascio\v2\TradeMark {
	...
	public function setContactLanguage (?string $ContactLanguage = null) : \ascio\v2\TradeMark {
	...
	public function setDocumentationLanguage (?string $DocumentationLanguage = null) : \ascio\v2\TradeMark {
	...
	public function setSecondContact (?string $SecondContact = null) : \ascio\v2\TradeMark {
	...
	public function setThirdContact (?string $ThirdContact = null) : \ascio\v2\TradeMark {
	...
	public function setRegDate (?\DateTime $RegDate = null) : \ascio\v2\TradeMark {
