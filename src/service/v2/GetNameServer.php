...
class GetNameServer extends RequestRootElement  {
	...
	public function setSessionId (?string $sessionId = null) : \ascio\v2\GetNameServer {
	...
	public function setNameServerHandle (?string $nameServerHandle = null) : \ascio\v2\GetNameServer {
