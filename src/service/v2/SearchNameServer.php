...
class SearchNameServer extends RequestRootElement  {
	...
	public function setSessionId (?string $sessionId = null) : \ascio\v2\SearchNameServer {
	...
	public function setCriteria (?\ascio\v2\SearchCriteria $criteria = null) : \ascio\v2\SearchNameServer {
