...
class Message extends DbBase  {
	...
	*/
	...
	public function setAttachments (?\ascio\v3\ArrayOfAttachment $Attachments = null) : \ascio\v3\Message {
	...
	public function setBody (?string $Body = null) : \ascio\v3\Message {
		$this->set("Body", $Body);
		return $this;
	}
	...
	public function setCreated (?\DateTime $Created = null) : \ascio\v3\Message {
	...
	public function setFromAddress (?string $FromAddress = null) : \ascio\v3\Message {
	...
	public function setSubject (?string $Subject = null) : \ascio\v3\Message {
	...
	public function setToAddress (?string $ToAddress = null) : \ascio\v3\Message {
	...
	public function setType (?string $Type = null) : \ascio\v3\Message {
		$this->set("Type", $Type);
		return $this;
	}
