...
// XSLT-WSDL-Client. Generated PHP class of GetContactsRequest

namespace ascio\service\v3;
use ascio\base\v3\Base;
use ascio\db\v3\GetContactsRequestDb;
use ascio\api\v3\GetContactsRequestApi;


class GetContactsRequest extends Base  {

	protected $_apiProperties=["Handle", "FirstName", "LastName", "OrgName", "OrganisationNumber", "Address1", "Address2", "City", "State", "PostalCode", "CountryCode", "Phone", "Fax", "Email", "Status", "CreationFromDate", "CreationToDate", "OrderSort", "PageInfo"];
