...
// XSLT-WSDL-Client. Generated PHP class of GetSslCertificatesRequest

namespace ascio\service\v3;
use ascio\db\v3\GetSslCertificatesRequestDb;
use ascio\api\v3\GetSslCertificatesRequestApi;
use ascio\base\v3\Base;


class GetSslCertificatesRequest extends Base  {

	protected $_apiProperties=["ObjectNames", "Handles", "Status", "SslComment", "CreationFromDate", "CreationToDate", "ExpireFromDate", "ExpireToDate", "OwnerName", "OwnerOrganizationName", "OwnerEmail", "CustomerReferenceExternalId", "CustomerReferenceDescription", "OrderSort", "PageInfo"];
	protected $_apiObjects=["ObjectNames", "Handles", "PageInfo"];
	protected $ObjectNames;
	protected $Handles;
	protected $Status;
	protected $SslComment;
	...
	public function setSslComment (?string $SslComment = null) : self {
		$this->set("SslComment", $SslComment);
		return $this;
	}
	public function getSslComment () : ?string {
		return $this->get("SslComment", "string");
	}
