...
class GetSslCertificatesRequest extends Base  {
	...
	protected $_apiProperties=["ObjectNames", "Handles", "Status", "SslComment", "CreationFromDate", "CreationToDate", "ExpireFromDate", "ExpireToDate", "OwnerName", "OwnerOrganizationName", "OwnerEmail", "OrderSort", "PageInfo"];
