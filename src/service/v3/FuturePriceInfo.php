...
// XSLT-WSDL-Client. Generated PHP class of FuturePriceInfo

namespace ascio\service\v3;
use ascio\db\v3\FuturePriceInfoDb;
use ascio\api\v3\FuturePriceInfoApi;
use ascio\base\v3\Base;


class FuturePriceInfo extends Base  {

	protected $_apiProperties=["Product", "Price", "ValidFrom", "ValidTo", "CurrentPrice"];
	...
	public function setCurrentPrice (?\decimal $CurrentPrice = null) : self {
		$this->set("CurrentPrice", $CurrentPrice);
		return $this;
	}
	public function getCurrentPrice () : ?\decimal {
		return $this->get("CurrentPrice", "\\decimal");
	}
}