...
class AbstractResponse extends DbBase  {
	...
	protected $_substitutions = [
		...
		["name" => "CancelOrderResponse","type" => "\\ascio\\v3\\CancelOrderResponse"], 
		["name" => "GetOrdersResponse","type" => "\\ascio\\v3\\GetOrdersResponse"], 
		["name" => "GetDomainsResponse","type" => "\\ascio\\v3\\GetDomainsResponse"], 
		["name" => "GetDefensivesResponse","type" => "\\ascio\\v3\\GetDefensivesResponse"], 
		...
		["name" => "GetRegistrantVerificationResponse","type" => "\\ascio\\v3\\GetRegistrantVerificationResponse"], 
		["name" => "StartRegistrantVerificationResponse","type" => "\\ascio\\v3\\StartRegistrantVerificationResponse"], 
		...
		["name" => "GetFuturePricesResponse","type" => "\\ascio\\v3\\GetFuturePricesResponse"], 
		...
		["name" => "DeleteHandleResponse","type" => "\\ascio\\v3\\DeleteHandleResponse"], 
		["name" => "GetCustomerReferenceResponse","type" => "\\ascio\\v3\\GetCustomerReferenceResponse"], 
		["name" => "CreateContactResponse","type" => "\\ascio\\v3\\CreateContactResponse"], 
		["name" => "CreateCustomerReferenceResponse","type" => "\\ascio\\v3\\CreateCustomerReferenceResponse"], 
		["name" => "UpdateCustomerReferenceResponse","type" => "\\ascio\\v3\\UpdateCustomerReferenceResponse"], 
		["name" => "DeleteCustomerReferenceResponse","type" => "\\ascio\\v3\\DeleteCustomerReferenceResponse"], 
		["name" => "SetCustomerReferencesResponse","type" => "\\ascio\\v3\\SetCustomerReferencesResponse"], 
		...
		["name" => "GetCustomerReferencesResponse","type" => "\\ascio\\v3\\GetCustomerReferencesResponse"], 
		...
		["name" => "GetNameWatchListResponse","type" => "\\ascio\\v3\\GetNameWatchListResponse"], 
		...
		["name" => "ResendMessageResponse","type" => "\\ascio\\v3\\ResendMessageResponse"], 
		...
		["name" => "CreateApprovalDocumentationResponse","type" => "\\ascio\\v3\\CreateApprovalDocumentationResponse"], 
		["name" => "UploadMessageResponse","type" => "\\ascio\\v3\\UploadMessageResponse"], 
		["name" => "GetSslCertificateChainResponse","type" => "\\ascio\\v3\\GetSslCertificateChainResponse"] 
	];
