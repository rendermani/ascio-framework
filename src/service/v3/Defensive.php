...
class Defensive extends DbBase  {
	...
	*/
	...
	public function setHandle (?string $Handle = null) : \ascio\v3\Defensive {
	...
	public function setName (?string $Name = null) : \ascio\v3\Defensive {
		$this->set("Name", $Name);
		return $this;
	}
	...
	public function setMarkHandle (?string $MarkHandle = null) : \ascio\v3\Defensive {
	...
	public function setAuthInfo (?string $AuthInfo = null) : \ascio\v3\Defensive {
	...
	public function setEncoding (?string $Encoding = null) : \ascio\v3\Defensive {
	...
	public function setOwner (?\ascio\v3\Registrant $Owner = null) : \ascio\v3\Defensive {
	...
	public function setAdmin (?\ascio\v3\Contact $Admin = null) : \ascio\v3\Defensive {
	...
	public function setTech (?\ascio\v3\Contact $Tech = null) : \ascio\v3\Defensive {
		$this->set("Tech", $Tech);
		return $this;
	}
	...
	public function setBilling (?\ascio\v3\Contact $Billing = null) : \ascio\v3\Defensive {
	...
	public function setReseller (?\ascio\v3\Contact $Reseller = null) : \ascio\v3\Defensive {
	...
	public function setObjectComment (?string $ObjectComment = null) : \ascio\v3\Defensive {
